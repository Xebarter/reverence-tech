      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-16">
          <div className="text-center">
            ...
            <h3 className="text-3xl font-bold text-primary-700 mb-2">5+</h3>
            <p className="text-gray-600 font-medium">Years Experience</p>
          </div>

          <div className="text-center">
            <div className="bg-yellow-100 w-20 h-20 rounded-full flex items-center justify-center mx-auto mb-4">
              <Users className="text-yellow-500" size={36} />
            </div>
            <h3 className="text-3xl font-bold text-primary-700 mb-2">200+</h3>
          ...
          <div className="text-center">
            ...
            <h3 className="text-3xl font-bold text-primary-700 mb-2">350+</h3>
          ...
          <div className="text-center">
            ...
            <h3 className="text-3xl font-bold text-primary-700 mb-2">98%</h3>
            <p className="text-gray-600 font-medium">Client Retention</p>
          </div>
        </div>

        <div className="bg-gradient-to-r from-primary-700 to-primary-900 rounded-2xl p-12 text-white">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="text-center">
                <div className="text-yellow-400 font-bold text-lg mb-2">Innovation</div>
                <p className="text-sm text-[#E5E8EB]">Cutting-edge solutions adapted for local needs</p>
              </div>
              <div className="text-center">
                <div className="text-yellow-400 font-bold text-lg mb-2">Accessibility</div>
                <p className="text-sm text-[#E5E8EB]">Technology within reach of every organization</p>
              </div>
              <div className="text-center">
                <div className="text-yellow-400 font-bold text-lg mb-2">Partnership</div>
